...
s = mkdir(['/Users/aha/Dropbox/Learning/2012_Kaggle/DarkSky/Matlab/new_version_gaussian/figure/' datafile '/']);
if(s(1)~=1)
    exit();
end
s = mkdir(['/Users/aha/Dropbox/Learning/2012_Kaggle/DarkSky/Matlab/new_version_gaussian/data/' datafile '/']);
if(s(1)~=1)
    exit();
end
...
parfor i =real_run
    ...
    if show
        ...
        saveas(h, ['/Users/aha/Dropbox/Learning/2012_Kaggle/DarkSky/Matlab/new_version_gaussian/figure/' datafile '/' num2str(i) '.png'],'png');
        close;
    end
...
fp = fopen(['/Users/aha/Dropbox/Learning/2012_Kaggle/DarkSky/Matlab/new_version_gaussian/data/' datafile '/1.csv'],'w+');
...
fp = fopen(['/Users/aha/Dropbox/Learning/2012_Kaggle/DarkSky/Matlab/new_version_gaussian/data/' datafile '/random.csv'],'w+');
fprintf(fp,'SkyId,pred_x1,pred_y1,pred_x2,pred_y2,pred_x3, pred_y3\n');
for i=I
